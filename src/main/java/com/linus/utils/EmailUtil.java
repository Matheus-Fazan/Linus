...
public class EmailUtil {
    ...
    public static void enviarEmail(String email, String codigoVerificacao) throws MessagingException, UnsupportedEncodingException, EntityNotFoundException, SQLException {
        ...
        String assunto = "Instituto Linus - Recuperação de senha";
        String mensagem = """
                            <div
                              style="
                            ...
                            >
                              ...
                              >
                                ...
                                <p style="color: #2c3036">
                                  Você solicitou a recuperação da sua senha de acesso ao Instituto
                                  Linus. Use o código abaixo para redefinir sua senha:
                                </p>
                                <div
                                  style="
                                    background: #fff;
                                ...
                                <p style="color: #888">
                                  Se você não solicitou essa alteração, por favor, desconsidere este
                                  email com segurança.
                                </p>
                                <hr style="border: 0; border-top: 1px solid #fff; margin: 30px 0" />
                                <p style="font-size: 12px; color: #2c3036; text-align: center">
                                  &copy; %s Instituto Linus. Todos os direitos reservados.
                                </p>
                              </div>
                            </div>
        ...
        System.out.println(EMAIL_REMETENTE);
        System.out.println(SENHA_REMETENTE);
